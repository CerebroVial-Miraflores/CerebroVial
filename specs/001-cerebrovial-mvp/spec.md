...
> **Nota (2026-06-02, DHU-028 y DHU-029):** el Product Backlog se amplió posteriormente a **23 HU + 13 TTH**: primero a 22 HU + 12 TTH con DHU-028 (HU-22: mapa de congestión de la red; TTH-12: infraestructura de datos de congestión por arista) y luego a 23 HU + 13 TTH con DHU-029 (HU-23: recorrido temporal de la congestión de la red; TTH-13: infraestructura de consulta histórica de congestión por arista). Esta especificación y su inventario de tareas (`tasks.md`) siguen reflejando el backlog de 21 HU + 11 TTH del que se derivaron y cuyos elementos están estimados en SP; la propagación de HU-22/TTH-12 y HU-23/TTH-13 a los artefactos Spec Kit, con su estimación, queda pendiente de una re-derivación. **Actualización 2026-06-03:** HU-22, HU-23 y TTH-12 ya están **construidas y mergeadas a master** (PRs #42, #43 y #41 respectivamente, 2026-06-02), pero **siguen ausentes del inventario de `tasks.md` y sin estimación SP**. El trabajo está entregado; el registro formal en los artefactos Spec Kit (propagar estas HU/TTH al inventario con su estimación) sigue pendiente de la re-derivación ya anunciada arriba.
