...
// (CameraStrip, CameraGrid, CameraDetailView, useVisionStream,
// useVisionAggregates) puedan seguir pisándolos sin romper — esos overrides
// locales quedan como están.
