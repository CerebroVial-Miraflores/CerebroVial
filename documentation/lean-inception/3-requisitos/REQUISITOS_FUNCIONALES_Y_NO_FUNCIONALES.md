...
> **Nota (2026-06-02, DHU-028 y DHU-029):** posteriormente al cierre, el Product Backlog se amplió a 23 HU + 13 TTH: primero a 22 HU + 12 TTH con HU-22 (mapa de congestión de la red) y TTH-12 (infraestructura de datos de congestión por arista, DHU-028), y luego a 23 HU + 13 TTH con HU-23 (recorrido temporal de la congestión de la red) y TTH-13 (infraestructura de consulta histórica de congestión por arista, DHU-029). Los "Candidatos a RNF" de HU-22 (performance de tiempo real, robustez ante interrupción Caso A, usabilidad/legibilidad panorámica, accesibilidad WCAG 2.1 AA — incluida RNF-INT-02 — y performance de carga del mapa) y de HU-23 (usabilidad de recorrido ágil, integridad de la representación —no recorrer vacío—, honestidad de la fuente, accesibilidad RNF-INT-02 y seguridad por rol) **aún no están consolidados** en este documento; su incorporación al catálogo RF/RNF queda como pasada futura. Por eso este documento sigue refiriéndose a las 21 HU de las que efectivamente deriva su catálogo actual.
