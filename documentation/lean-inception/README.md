...
**[`BACKLOG_OVERVIEW.md`](BACKLOG_OVERVIEW.md)** — visión de conjunto del producto en 10 minutos (4 Personas, 4 Objetivos, mapa de 23 HU + 13 TTH, navegación al detalle).
...
| 2 | `2-backlog/` | Detalle implementable: 23 HU operativas organizadas en bloques A-F + 5 MVP2 (incluidas las ampliaciones HU-22 (DHU-028) y HU-23 (DHU-029)) + 13 TTH + 41 features. |
