...
| Bloque B | HU-02 a HU-09, HU-22 | TTH-12 (ampliación, DHU-028) | DHU-003, DHU-005 (refinada con A y B), DHU-006, DHU-007, DHU-028 |
...
- `HU_BLOQUE_B.md` — Bloque B del Product Backlog (9 HUs, 7 MVP1 + 1 MVP2 + 1 ampliación: HU-22).
...
- `TAREAS_TECNICAS_HABILITADORAS.md` — TTH-01 a TTH-12.
